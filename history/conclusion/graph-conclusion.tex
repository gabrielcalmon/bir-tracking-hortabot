% Created by tikzDevice version 0.12.3.1 on 2022-08-29 10:29:20
...
\path[fill=fillColor] (212.17, 60.92) rectangle (241.94,514.41);
\definecolor{fillColor}{gray}{0.75}

\path[fill=fillColor] (245.24, 60.92) rectangle (275.01,487.20);

\path[fill=fillColor] (278.32, 60.92) rectangle (308.09,495.13);

\path[fill=fillColor] (311.40, 60.92) rectangle (341.17,492.24);

\path[fill=fillColor] (344.48, 60.92) rectangle (374.25,465.60);

\path[fill=fillColor] (377.55, 60.92) rectangle (407.32,495.44);

\path[fill=fillColor] (410.63, 60.92) rectangle (440.40,496.65);

\path[fill=fillColor] (443.71, 60.92) rectangle (473.48,491.38);

\path[fill=fillColor] (476.79, 60.92) rectangle (506.56,502.65);

\path[fill=fillColor] (509.86, 60.92) rectangle (539.63,491.89);

\path[fill=fillColor] (542.94, 60.92) rectangle (572.71,514.41);
\definecolor{drawColor}{RGB}{46,139,87}

\path[draw=drawColor,line width= 1.7pt,line join=round] (227.05,110.80) --
	(260.13,120.60) --
	(293.21,130.39) --
	(326.28,138.56) --
	(359.36,145.90) --
