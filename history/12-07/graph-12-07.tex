% Created by tikzDevice version 0.12.3.1 on 2022-07-12 15:10:03
...
\path[fill=fillColor] (179.09, 60.92) rectangle (208.86,524.49);

\path[fill=fillColor] (212.17, 60.92) rectangle (241.94,530.90);

\path[fill=fillColor] (245.24, 60.92) rectangle (275.01,501.45);

\path[fill=fillColor] (278.32, 60.92) rectangle (308.09,490.03);

\path[fill=fillColor] (311.40, 60.92) rectangle (341.17,481.15);

\path[fill=fillColor] (344.48, 60.92) rectangle (374.25,463.88);

\path[fill=fillColor] (377.55, 60.92) rectangle (407.32,486.37);

\path[fill=fillColor] (410.63, 60.92) rectangle (440.40,488.33);

\path[fill=fillColor] (443.71, 60.92) rectangle (473.48,482.31);

\path[fill=fillColor] (476.79, 60.92) rectangle (506.56,488.88);

\path[fill=fillColor] (509.86, 60.92) rectangle (539.63,483.45);

\path[fill=fillColor] (542.94, 60.92) rectangle (572.71,514.41);
\definecolor{drawColor}{RGB}{46,139,87}

\path[draw=drawColor,line width= 1.7pt,line join=round] (160.90, 92.66) --
	(193.97,102.64) --
	(227.05,112.62) --
	(260.13,122.59) --
	(293.21,129.58) --
